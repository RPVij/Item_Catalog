...
@app.route('/')
@app.route('/sports/')
# Defining a function showSports:
def showSports():
    print(login_session)
    # Creating a variable sports
...
# Showing a Sport detail with Players:
@app.route('/sports/<int:sports_id>/')
# Defining a function showSportsDetail :
def showSportsDetail(sports_id):
        # Creating a variable sports_and players
...
# Defining a function SportsJSON:
def sportsJSON():
	# Creating a variable sports
    sports = session.query(Sports).all()
...
# Defining a function SportsPlayerJSON:
def sportsPlayerJSON(sports_id):
    # Creating a variable Sports_Player
...
# Defining a function SportsPlayerIDJSON:
...
# Defining a function editSports:
def editSports(sports_id):
    # Creating a variable editedSports
...
# Defining a function deleteSports:
def deleteSports(sports_id):
    # Creating a variable sportsToDelete
...
def gconnect():
    ...
    # For later use storing the access token in the session.
...
# Defining a function createUser:
def createUser(login_session):
    # Creating a variable newUser
...
# Defining a function getUserInfo:
...
# Defining a function gdisconnect:
def gdisconnect():
    # Creating a variable access_token
